...
- `/user/subscription`：免費社區與 VIP 訂閱社區的方案、功能比較與 Demo 升級入口；免費住戶仍可瀏覽、參加與發起團購，其餘社區服務會顯示訂閱解鎖。
...
- `/demo/subscription`：28 戶落在的級距月費、導入期免費試用、住戶省下與社區淨效益。
...
9. 進入 `/demo/subscription`，展示 28 戶落在 1–30 戶級距的月費 NT$999／月、導入期免費試用 3–6 個月、本月住戶省下 NT$4,620 與淨效益 +NT$3,621（＝ 4,620 − 999，刻意用級距全價保守估）。
