...
### 1.2 定位（已定案）
- **核心與基線**：社區服務整合是競賽版核心場景；個人服務是不屬於任何社區者也能使用的產品基線（[ADR-0005](../adr/0005-community-core-personal-extension.md)）。
- **主要展示**：DUSKIN 社區冷氣聯合清洗是 Hero；個人「今日生活中心」是第二條主要展示線（[ADR-0010](../adr/0010-hero-personal-hub-and-service-breadth.md)）。
- **共用範圍**：個人、家庭與社區以 `scope` 概念共用同一套資料與能力（[ADR-0003](../adr/0003-scope-as-core-attribute.md)）。
...
| 介面 | 使用者 | 說明 |
| --- | --- | --- |
| Web 住戶工作區 | C | 今日生活中心、服務目錄、AI 對話、填答、訂單、提醒與優惠 |
| Web 社區營運工作區 | M | 聯合預約、團購、推播、活動企劃與成效分析 |
...
| FR-C-06 | 社區聯合服務：管理者發起服務活動、住戶填需求與時段、系統彙整數量並媒合/通知合作廠商 | C·M·B | **P0** | Hero 使用 DUSKIN 冷氣聯合清洗；不是管理費或商品團購 |
...
| FR-S-06 | 廣服務目錄：官方 8 項服務＋商城購物共 9 項皆可完成填答、建立諮詢單/訂單及查狀態；DUSKIN、黑貓、foodomo、EZTABLE、7-ELEVEN 做深度整合 | 全 | **P0** | 不允許只有無後續行為的服務卡片 |
...
| NFR-12 | 前端技術基線 | Web 採 Vue 3＋Vite SPA；四工作區共用設計 token 與基礎元件，靜態產物可部署至 S3/CloudFront |
...
### 6.1 P0 核心清單（端到端＋上鏡）
FR-X-01/03/04/05/06/07/08、FR-S-01/02/04/06、FR-C-06、FR-P-01/02/03/05/10/11/13/14、FR-V-01/02/03/04/06。
→ 形成兩條端到端主線：**DUSKIN 社區冷氣聯合清洗**與個人**今日生活中心**；平台整合中心再證明 9 項可操作服務、五條深度品牌服務及三種廠商接入模式。

### 6.1.1 建置階段（已定案）

| Phase | 叢集 | 主要需求 | 依賴/理由 |
| --- | --- | --- | --- |
| **1** | 平台共用閉環 | 四工作區骨架、統一服務契約、題組引擎、諮詢/訂單、事件與權限 | Hero、個人與品牌服務都依賴 |
| **2** | 社區 Hero＋廠商 | FR-C-06、FR-S-01/04、FR-V-01~04/06；DUSKIN 冷氣聯合清洗端到端 | 先做最能對齊命題與品牌的完整故事 |
| **3** | 今日生活中心 | FR-X-05/06、FR-P-01/02/03/05/10/11/13/14 | 第二主展示線；官方訂單＋種子資料即可支撐 |
| **4** | 服務廣度與接入證明 | FR-S-06；9 項可操作服務、五條深度品牌服務、三種接入模式 | 證明不是單一冷氣網站與接入平台賣點 |
| **5** | 家庭、團購與超商深化 | FR-F-01~04、FR-C-01~03、FR-P-40~45 | 重用前四階段能力，依剩餘工時逐項完成 |
| **6** | 情境模板與延伸通路 | 天氣/節慶/咖啡/健康/旅遊/考試週、LINE 語音、ibon、小賣家 | 保留在同一推薦/任務/服務引擎，不另建獨立系統 |

### 6.2 已定案的產品取捨

- **主要介面**：單一 RWD Web 平台四工作區；LINE 是延伸通路（ADR-0006）。
...
- **Demo 主線**：DUSKIN 社區冷氣聯合清洗＋今日生活中心＋平台接入證明（ADR-0010）。
- **服務廣度**：9 項皆可操作；DUSKIN、黑貓、foodomo、EZTABLE、7-ELEVEN 五條做深。
- **服務媒合**：官方服務來源與實際合作廠商分離，多合作廠商輕量比較（ADR-0009）。
- **廠商接入**：標準、轉接、工作台三種模式（ADR-0007）。
...
### 6.3 技術決策補充
- **MCP 邊界**：厚 MCP（加值智慧也上），按域拆 6 server（life-services／order／community／retail／personal-intelligence／backoffice）；內部保留通路/意圖/題組對話/任務排序/記憶/推播。見 [04](04-mcp-and-api.md)。
