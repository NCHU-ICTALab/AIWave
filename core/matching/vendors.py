...
VENDORS: tuple[Vendor, ...] = (
    ...
    Vendor(
        id="vendor-prince-property-flex",
        name="太子物業（彈性排程）",
        intro="太子物業競賽情境方案，可協調平日夜間與假日服務。",
        rating=4.5,
        review_count=386,
    ...
    Vendor(
        id="vendor-prince-property-regular",
        name="太子物業（定期家事）",
        intro="太子物業競賽情境方案，以計時家事與定期排程為主。",
        rating=4.3,
        review_count=512,
        supports_urgent=False,
        counties=_WIDE,
    ...
    # ---- 水電修繕 ----
    Vendor(
        id="vendor-prince-electric-urgent",
        name="王子水電（加急派遣）",
        intro="王子水電競賽情境方案，可提出漏水、跳電與線路異常加急需求。",
        rating=4.4,
        review_count=903,
        supports_urgent=True,
        counties=_NORTH,
    ...
    Vendor(
        id="vendor-prince-electric-booking",
        name="王子水電（預約檢測）",
        intro="王子水電競賽情境方案，採預約檢測與一般排程。",
        rating=4.7,
        review_count=248,
        supports_urgent=False,
        counties=_NORTH | _TAICHUNG,
    ...
    Vendor(
        id="vendor-prince-electric-flex",
        name="王子水電（彈性時段）",
        intro="王子水電競賽情境方案，提供夜間與假日時段選擇。",
        rating=4.1,
        review_count=1580,
        supports_urgent=True,
        counties=_WIDE,
